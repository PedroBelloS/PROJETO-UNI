            ...
            <div class = "caixas">
                ...
                <div class= "caixa2">
                    ...
                    <div class = "div1">
                       ...
                       <div class="caixa24">
                            <div class="lado-esquerdo">
                                <input type="checkbox" name="exercicios[]" value = "Tríceps francês (halter ou barra)">
                                <b>Tríceps francês (halter ou barra)</b><br>
                            </div>

                            <div class="lado-direito">
                                <label><b>Série</b>
                                    <input class= "serie" type="number"name="serie[Tríceps francês (halter ou barra)]" >
                                </label>

                                <label><b>Rep</b>
                                    <input class= "serie" type="number"name="rep[Tríceps francês (halter ou barra)]" >
                                </label>
                            </div>
